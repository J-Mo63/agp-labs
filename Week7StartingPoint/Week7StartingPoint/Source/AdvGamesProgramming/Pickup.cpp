...
APickup::APickup()
{
    ...
    PickupSceneComponent = CreateDefaultSubobject<USceneComponent>(TEXT("PickupComponent"));
    RootComponent = PickupSceneComponent;

    PickupBoundingBox = CreateDefaultSubobject<UBoxComponent>(TEXT("Box Component"));
    PickupBoundingBox->SetupAttachment(RootComponent);
